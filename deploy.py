#!/usr/bin/env python3
"""
Source latest NBA game data, train an Elo regressor, generate a league
...
def team_names():
    ...
    """
    return {t.abbreviation: t.name for t in NBATeams()}
...
def get_season_team(season_team, current_season):
    ...
    cachedir = Path('~/.local/share/sportsref/nba').expanduser()
